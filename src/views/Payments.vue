<template>
  <v-container>
    ...
    <v-dialog v-model="showDialogPayment" width="500">
      <v-card class="pa-3">
        <div class="text-xs-right" @click="showDialogPayment=false">
          <a>Fechar</a>
        </div>
...
export default {
  ...
  created() {
    ...
    this.$store.dispatch("getMonthPayments", params).then(payments => {
